...
class HomeVM {
    ...
    var taskList: [TaskModel] {
        ...
        set {
            saveTaskList(taskList: newValue)
        }
    }
...
//    ]
    init() {
        taskList = userDefaultsManager.getTasks()
    }
    
    
    private func getTaskList() ->[TaskModel] {
        return userDefaultsManager.getTasks()
    }
    
    private func saveTaskList(taskList: [TaskModel]) {
        userDefaultsManager.saveTasks(tasks: taskList)
    }
